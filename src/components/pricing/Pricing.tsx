    ...
    <section className={styles.pricingSection} id="pricing">
      <div className={styles.content}>
        ...
        <div className={styles.pricingCards}>
          ...
          >
            <div className={styles.popularBadge}>Le plus choisi</div>
            <h3 className={styles.planName}>Pass Premium</h3>
            ...
            <ul className={styles.featuresList}>
              <li className={styles.featureItem}>
                ...
                Études Guidées illimitées
              </li>
              <li className={styles.featureItem}>
                <svg className={styles.checkIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                Évaluations personnalisées (Cas pratiques, QCM)
              </li>
              <li className={styles.featureItem}>
                <svg className={styles.checkIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                Correction de rédactions par l'IA
              </li>
              <li className={styles.featureItem}>
                <svg className={styles.checkIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
