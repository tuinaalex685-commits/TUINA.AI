      ...
      >
        ...
        <motion.div variants={fadeUp} className={styles.founderCard}>
          ...
          <div className={styles.content}>
            ...
            <p>
              C'est exactement pour cela que SJP a été créé. C'est <strong>l'outil qu'il nous manquait</strong> pour y voir clair, gagner du temps et réussir sereinement — quelle que soit l'année d'études.
            </p>
          </div>
